  ...
  return (
    ...
    <>
      ...
      <div id="Home" className="h-screen  flex flex-col justify-center flex-wrap bg-[#DBCAF4]">
        ...
        <div
          id="Home-items"
          className="px-4 grid md:grid-cols-2 md:justify-items-start md:content-between md:justify-start mt-36">
          ...
          <div id="Home--text-container" className="grid justify-items-center">
            ...
            <h1 id="Home--title" className="pb-4 text-3xl font-bold text-center">
