...
const DashboardPatient = () => {
  ...
  return (
    <>
      ...
      {nav ? (
        <div
          className={`fixed w-full h-screen bg-white/90 flex flex-col justify-center items-center z-20 ${elementClassName} md:hidden`}>
      ...
      <div className="w-1/6 hidden md:block  bg-[#DBCAF4] ">
        ...
        <h1 className="mx-auto mt-4 text-center font-bold text-purple-700 text-xl">
